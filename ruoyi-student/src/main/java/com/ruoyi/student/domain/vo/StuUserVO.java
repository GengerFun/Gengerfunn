 ...
 * @date 2024-12-11
 */
public class StuUserVO extends BaseEntity
{
    private static final long serialVersionUID = 1L;

    private StuEnrollment stuEnrollment;
    ...
    public StuEnrollment getStuEnrollment() {
        return stuEnrollment;
    }

    public void setStuEnrollment(StuEnrollment stuEnrollment) {
