 ...
 * @date 2024-12-11
 */
public class StuMaterialPickupVo extends BaseEntity
{
    ...
    public StuMaterial getStuMaterial() {
        return stuMaterial;
    }

    public void setStuMaterial(StuMaterial stuMaterial) {
        this.stuMaterial = stuMaterial;
    }
